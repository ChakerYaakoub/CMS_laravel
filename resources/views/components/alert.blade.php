...
@php
    $colors = [
        'default' => ' border border-green-500   text-green-800 bg-green-50',
...
<div x-data="{ open: true }" x-show="open"
    class=" {{ $colorClass }} relative  border-t-4  rounded-b  px-4 py-3 shadow-md" role="alert">
    <div class="flex">
        <div class="py-1"><svg class="fill-current h-6 w-6  mr-4 {{ $colorClass }}  border-0"
