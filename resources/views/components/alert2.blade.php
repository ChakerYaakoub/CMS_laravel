...
@php
    $colors = [
        'info' => ['bg' => 'blue', 'text' => 'blue', 'icon' => 'fa-ruler-vertical'],
        'error' => ['bg' => 'red', 'text' => 'red', 'icon' => 'fa-ruler-vertical'],
        'success' => ['bg' => 'green', 'text' => 'green', 'icon' => 'fa-ruler-vertical'],
        'warning' => ['bg' => 'yellow', 'text' => 'yellow', 'icon' => 'fa-ruler-vertical'],
    ];
@endphp
